...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    const setViewportHeight = () => {
      // Hem Android hem iOS'ta gerçek viewport height'ı kullan
      // Visual Viewport API varsa onu kullan (daha doğru)
      let currentHeight: number;
      
      if (window.visualViewport) {
        // Visual Viewport API klavye açık/kapalı durumunu doğru yansıtır
      ...
      // iOS'ta scroll position'ı koru (sayfa yukarı kaymasın)
      if (isIOSDevice && window.scrollY > 0) {
    ...
    // Scroll position'ı takip et (iOS'ta korumak için)
    const handleScroll = () => {
    ...
    // Visual Viewport API varsa onu dinle (en hassas)
    if (window.visualViewport) {
