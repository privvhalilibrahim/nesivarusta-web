    ...
    <div className="h-screen w-full max-w-none bg-gray-950 text-white overflow-hidden flex flex-col">
      ...
      <div className="flex-1 min-h-0 w-full flex flex-col md:flex-row relative">
        ...
        <button
          ...
          disabled={showResult}
          className={`flex-1 min-h-0 min-w-0 flex flex-col transition-all duration-300 relative overflow-hidden group ${
            showResult ? "cursor-default" : "cursor-pointer"
          }`}
        >
          <div
            className={`flex-1 min-h-[40vh] md:min-h-0 w-full relative border-4 transition-all duration-300 ${
